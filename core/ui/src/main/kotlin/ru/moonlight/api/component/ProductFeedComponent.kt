...
fun ProductFeed(
    ...
    when {
        ...
        isPagerEmpty(productFeedModelList.itemCount) -> {
            EmptyFeed(
                modifier = modifier,
                onChangeFiltersClick = onChangeFiltersClick
            )
        }
        else -> {
            FilledFeed(
...
private fun EmptyFeed(
    ...
    Column(
        ...
        Column(
            ...
            SecondTitleTextWidget(text = stringResource(R.string.catalogEmpty))
            TextFieldTextWidget(text = stringResource(R.string.productsNotFoundByFilters))
        }
        ...
        ButtonWidget(
            ...
            text = stringResource(R.string.changeFilters),
        )
    }
}
