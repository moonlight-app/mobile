 ...
 * for the [OTPTemplate].
 * This class provides a flexible way to customize the appearance of digit containers in [OTPTemplate].
 *
 ...
 */
internal sealed class DigitContainerStyle(
    ...
    /**
     * Represents an outlined style for the digit container of our [OTPTemplate].
     *
    ...
    /**
     * Represents an underlined style for the digit container of our [OTPTemplate].
     *
     * @property size The size of the digit container.
     */
